...
def show():
    ...
    try:
        ...
        df = pd.read_sql_query(query, engine, params={'symbol': selected_symbol, 'date': threshold_date})
        ...
        if not df.empty:
            ...
            indicators = pd.read_sql_query(query, engine, params={'symbol': selected_symbol, 'date': threshold_date})
